...
Что не трогать — см. `../../rules/agentops-auto-clarity.md`. Кратко: правила о безопасности и необратимых действиях остаются развёрнутыми, любой код, путь, флаг и имя переменной — байт-в-байт.

...
description: Превращает идею, заметку или сырой текст в готовый пост для Telegram-канала — плотный, с тезисом первым, авторским голосом, в пределах 500-1500 символов. Используй, когда пользователь хочет «написать пост в тг», «оформить мысль для канала», «короткий пост», «tg-пост», «оформить идею для подписчиков».
---
...
- `../../rules/content-voice.md` — авторский голос (обращение «ты», не Wikipedia)
- `../../rules/content-formatting.md` — раздел Telegram

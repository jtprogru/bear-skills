...
- `../../rules/note-types-frontmatter.md` — шаблоны и поля frontmatter
- `../../rules/knowledge-structures.md` — атомарные заметки, MOC, синтезы
- `../../rules/content-style.md` — язык, стиль, wikilinks
- `../../rules/tags.md` — таксономия тегов
...
- **Не плоди теги** — используй существующую таксономию из `../../rules/tags.md`

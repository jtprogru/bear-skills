...
Базовые правила (PARA, теги, frontmatter, стиль, имена файлов) — в `../../rules/`. Особенно: `tags.md` (раздел «Структурные теги»), `note-types-frontmatter.md`, навык `/knowledge-structures` (атомарные заметки), `file-naming.md`.
